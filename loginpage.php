...
<body>
            ...
            <div class="col-lg-6">
                ...
                <section id="signupSection" class="section">
                    ...
                    <form id="signupForm" action="proc/reg.php" method="POST">
                        ...
                        <div class="mb-3">
                            <input type="email" class="form-control" name="abc" placeholder="Email" required />
                            <div id="abcabc"></div>
                        </div>
                        <div class="mb-3">
                            <input type="text" class="form-control" name="phone" placeholder="Phone Number (Starting with 9)" required />
    ...
    <script>
        ...
        // Email validation
        const emailInput = document.querySelector('input[name="abc"]');
        const emailValidation = document.getElementById('abcabc');
        ...
        const phoneInput = document.getElementsByName('phone')[0]; // Get the phone number input element
        const phoneValidation = document.getElementById('phone-validation');

        phoneInput.addEventListener('input', function () {
            const phoneNumber = phoneInput.value;

            // Regular expression to validate phone number (starting with 9 and 9 digits in total)
            const phoneRegex = /^9\d{9}$/;

            if (phoneRegex.test(phoneNumber)) {
                phoneValidation.innerHTML = '<p class="text-success">Phone number is valid.</p>';
            } else {
                phoneValidation.innerHTML = '<p class="text-danger">Invalid phone number. It should start with 9 and be 10 digits in total.</p>';
            }
        });
    </script>
</body>
