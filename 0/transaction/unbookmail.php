...
// Now you can use these values as needed in your mail.php logic
echo "Received ID: " . $tid . "<br>";
...
$sql = "SELECT id FROM booking WHERE transaction_code = ?";
$stmt = $conn->prepare($sql);
...
// Add your mail-related logic here
...
$subject="Unbook Alert";
        ...
        try {
            ...
            $mail->Body    = "Dear ".$email.",<br><br><b>Unbooking Successful!</b><br>Date: ".$date."<br>Booking ID: ".$booking_id."<br>Parking Area: ".$area."<br>Lot Number: ".$lot_no."<br>Duration: ".$duration."<br>Fee: RS. ".$fee."<br>Transaction ID: ".$txn."";
            $mail->AltBody = ' ';
