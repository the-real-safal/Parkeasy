...
<div class="container mt-5">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" id="selectDate" max="<?php echo date('Y-m-d'); ?>">
    </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.36/vfs_fonts.js"></script>
    ...
    <!-- Your PHP and HTML code remains the same as before -->
    <script>
    $(document).ready(function () {
        ...
        $('#selectDate').on('change', function () {
            ...
            transactionTable.column(1).search(selectedDate).draw();
        });
    });
</script>
