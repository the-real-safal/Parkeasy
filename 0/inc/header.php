...
<style>
  .custom-nav {
      ...
      align-items: center;
      background-color: rgba(237, 242, 244, 0.8); /* Use rgba for transparency */
      padding: 20px;
...
<header>
  <nav class="custom-nav">
    ...
    <ul class="nav-list">
    <li><a href="http://localhost/pms002/0/index.php">Home</a></li>
      <li><a href="http://localhost/pms002/0/users.php">Users</a></li>
      <li class="dropdown"><a href="http://localhost/pms002/0/booking.php">Bookings</a></li>
      <li class="dropdown"><a href="http://localhost/pms002/0/transaction/alltransaction.php">Transactions</a></li>
      <li class="dropdown"><a href="http://localhost/pms002/0/messages.php">Messages</a></li>
      <li class="dropdown"><a href="http://localhost/pms002/0/faq/view.php">FAQs</a></li>
      <?php if ($_SESSION['access'] == 0) { ?>
